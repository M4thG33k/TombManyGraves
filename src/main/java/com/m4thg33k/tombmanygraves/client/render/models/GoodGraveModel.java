...
public class GoodGraveModel implements IBakedModel {
    ...
    public TextureAtlasSprite getParticleTexture() {
        return Minecraft.getMinecraft().getTextureMapBlocks().getAtlasSprite("tombmanygraves:blocks/BlockDeath");
    }
    ...
    private static class FakeBlockAccess implements IBlockAccess {
        ...
        public IBlockState getBlockState(BlockPos pos) {
            ...
            if (state.getBlock() instanceof BlockDeath)
            {
                state = ((TileDeathBlock) compose.getTileEntity(pos)).getCamoState();
            }
